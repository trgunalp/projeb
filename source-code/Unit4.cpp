      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
  ...
  Form1->StatusBar1->Panels->Items[0]->Text = Format("Baþlangýç Koordinat Takýmý: (%d, %d)", tempvar, 2);
}
//---------------------------------------------------------------------------
      ...
      int X, int Y)
{
  if (Drawing){
    ...
    TVarRec tempvar[2] = {X, Y};
  Form1->StatusBar1->Panels->Items[1]->Text = Format("Koordinat Takýmý: (%d, %d)", tempvar, 2);
}
//---------------------------------------------------------------------------
