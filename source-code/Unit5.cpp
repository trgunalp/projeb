  ...
  StringGrid1->Cells[5][30] = "0";
   StringGrid1->Cells[6][30] = "0";
    ...
    if ((Dosyabm = fopen("Data\\Betonarme.prjb", "r+b"))== NULL)
    {
     ...
     Tus = Application->MessageBoxA("Betonarme.prjb adlý dosya hazýrlansýn mý?",
...
{
ShowMessage("Uyarý: Kesit yetersiz!");
